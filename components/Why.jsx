...
const Why = () => {
  return (
    <section className="why-OFB overflow-x-hidden bg-purple-200 px-8 py-8 lg:px-8 lg:py-16">
      <div className="container mx-auto">
        ...
        <div className="flex flex-col justify-around gap-4 lg:flex-row lg:gap-0">
          {why.map((item, index) => (
            <div
              data-aos="zoom-in"
