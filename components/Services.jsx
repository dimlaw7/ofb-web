...
const Services = () => {
  ...
  return (
    <section className="services overflow-x-hidden px-8 lg:px-0">
      <div className="container mx-auto flex flex-col items-center justify-between py-8 lg:flex-row lg:py-16">
        ...
        <div className="wrap-cards flex w-full flex-col gap-4 lg:w-9/12 lg:flex-row">
          {services.map((item, index) => (
            <div
              data-aos={item.aos}
              className={`card flex w-[300px] shrink-0 flex-col items-center gap-8 rounded-3xl border border-light px-8 py-24 shadow ${index == 1 ? "lg:ofb-shadow" : ""}`}
              key={index}
            >
